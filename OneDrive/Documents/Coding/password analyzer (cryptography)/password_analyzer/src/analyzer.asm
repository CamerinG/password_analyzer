...
section .data
    ; 5.6f  = 0x40B33333 ---- 5.6 is the difference of the maximum and minimum score log2( 94 * 15) = 10.5 (max) and log2( 10 * 3) = 4.9 (min)
    ; 4.9f  = 0x409CCCCD ---- 4.9 is our min entropy
    ; 100.0f= 0x42C80000
    ; 0.0f  = 0x00000000

    range_entropy: dd 0x40B33333       
    min_entropy: dd 0x409CCCCD          
    score_scale: dd 0x42C80000
    zero_float: dd 0x00000000
